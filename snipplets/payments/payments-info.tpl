    ...
    <div id="installment-cash-option-{{ method }}" class="box p-3">
        ...
        {% if method in ['boleto_paghiper'] and discount > 0.0 %}
            ...
            <h3 class="font-weight-normal mb-3">
                ...
                <span class="js-installments-one-payment opacity-50 price-compare h4 font-weight-normal">{{ product.price | money }}</span><strong class="js-price-with-discount" data-payment-discount="{{ discount }}">{{ price_with_boleto_discount | money }}</strong>
            </h3>
