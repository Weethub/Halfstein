...
<p class="ref"><span class="text-uppercase">Ref: </span><span id="sku-product">{{ product.sku }}</span></p>
...
{# Product form, includes: Variants, CTA and Shipping calculator #}
 ...
 <form id="product_form" class="js-product-form" method="post" action="{{ store.cart_url }}" data-store="product-form-{{ product.id }}">
    ...
    <div class="form-row mb-2">
        ...
        <div class="{# col-8 pr-0 #} col-11 px-0">

            {# Add to cart CTA #}

            <input type="submit" class="js-addtocart js-prod-submit-form btn btn-primary btn-block mb-4 {{ state }}" value="Comprar" {% if state == 'nostock' %}disabled{% endif %} />
